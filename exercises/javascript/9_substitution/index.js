...
// Exercise 36: Strip html tags out of text
...
// Exercise 37: Substitute any multiple whitespace
// characters (including newlines) with a single
// space character
export const multipleWhitespaceRegex = /\s{2,}/sg;
export const multipleWhitespaceReplacement = ' ';


// Exercise 38: Strip off any whitespace characters
...
// Exercise 39: Switch a list of names (separated by newlines)
...
// O'Connor, Flannery
export const nameSwitchRegex = /^(\w+) ([\w\-\']+)$/mg;
export const nameSwitchReplacement = '$2, $1';

// Exercise 40: Building on the last exercise: Put last name
...
export const multiNameSwitchRegex = /^([\w ]+) ([\w\-\']+)$/mg;
